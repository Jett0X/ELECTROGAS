...
void loop() {
   ...
   lcd.print("H2 Concentration::");        // print message at (0, 0)
   lcd.setCursor(0, 1);
   lcd.print(MQGetGasPercentage(MQRead(MQ_PIN)/Ro,GAS_H2));        // print message at (0, 0)
   lcd.print("ppm");        // print message at (0, 0)
   delay(200);
}
